...
public class ListProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        String todos = values.getAsString(ListEntry.NAME);

        String date = values.getAsString(ListEntry.SYMPTOMS);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case LIST_ID:
                if (values.containsKey(ListEntry.NAME)) {

                    String todos = values.getAsString(ListEntry.NAME);

                }
                if (values.containsKey(ListEntry.SYMPTOMS)) {
                    String date = values.getAsString(ListEntry.SYMPTOMS);
