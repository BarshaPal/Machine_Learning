...
public class ListCursorAdapter extends CursorAdapter {
    ...
    public ListCursorAdapter(Context context, Cursor c) {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            String TodoList = cursor.getString(cursor.getColumnIndex(ListContract.ListEntry.NAME));
            String currDate = cursor.getString(cursor.getColumnIndex(ListContract.ListEntry.SYMPTOMS));
